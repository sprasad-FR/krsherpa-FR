...
@Component({
  ...
  templateUrl: './THDashboard.component.html',
  styleUrls: ['./THDashboard.component.scss'],
...
*/
 ...
 private async geteventchart() {
  ...
  let filter = {
    ...
    "endDate": new Date,
    "subPnLId":"5bdfc4f21d10940605ee7992" ,
    "region "  : "APAC"
  }
   var apacev;

   apacev=this.eventcount4periodBySpl(filter,'APAC') 
   ...
   apacev1=this.eventcount4periodBySpl(filter,'AMERICAS')

   filter = {
    "startDate": "2023-05-01",
    "endDate": new Date,
    "subPnLId":"60a2b8466fc81f44dca3c206",
    "region "  : "EMEA" }
   var apacev2;

   apacev2=this.eventcount4periodBySpl(filter,'EMEA')
...
getrole()
{
  ...
  if( this.krroles.includes('admin') || this.krroles.includes('mainPLHead'))
{

return 'Admin'
}
else if( this.krroles.includes('subPLHead') || this.krroles.includes('subPLHead'))
{

return 'subPLHead'
}
else if( this.krroles.includes('keyAccountManager') || this.krroles.includes('keyAccountManager'))
{

return 'keyAccountManager'
}
else if( this.krroles.includes('researchManager') || this.krroles.includes('researchManager'))
{

return 'researchManager'
}

else if( this.krroles.includes('researchAnalyst') || this.krroles.includes('researchAssociate'))
{
...
var  seris=[
    {
      name: 'Event count',
      data: [this.prjExpectedEventcountUS["count"],this.prjExpectedEventcountA["count"],this.prjExpectedEventcountE["count"]],
    }
  ];
...
//this.KACWiseExpEventCnt(userIdsE.join(','),'E')
...
this.prjcountA=result[0];

//prjcountE :any;
//prjcountA :any;
//prjcountUS :any;
//this.KACWiseExpEventCnt(userIdsA.join(','),'A')
...
this.prjcountUS=result[0];

//this.KACWiseExpEventCnt(userIdsUS.join(','),'U')
...
if (type=="A")
{
  this.prjExpectedEventcountA=result[0].count
}
else if (type=="E")
{
  this.prjExpectedEventcountE=result[0].count
}
else if (type=="U")
{
  this.prjExpectedEventcountUS=result[0].count
  this.drawchartevnt();
}
