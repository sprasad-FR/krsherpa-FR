...
id="5a27db8fd7d1377e69ed21e9";
 ...
 let start="2010-01-01";
  ...
  ngOnInit(): void {
   this.fetch1();
    this.KACWiseExpEventCnt();
    this.clientPayableAmount();
    this.getExpertCountByPOC();
    this.Expertcount4POC();
    this.eventcount4period();
    this.eventcount4periodBySpl();
    this.TRRCount4emp();
    this.TRRCount4Team();
    this.projectlist4period();
    this.projectlist4periodbyKAC();
    this.empByRegion();
    this.getlatest5Projects();
    //this.repotingManagerId();
...
const urlTree: UrlTree = this.router.createUrlTree(['events/view', id]);
...
//https//middle.krsherpa.com/dashboard/getlatest5Events4status:
  fetch('https://middle.krsherpa.com/dashboard/getlatest5Events4status', {
    method: "POST",
...
private KACWiseExpEventCnt() {
 ...
 //   get clientPayableAmount and expertPayment grouped by clientCurrency and expertCurrency respectively for a given eventAt date parameters 
private clientPayableAmount() {

  let filter = {
    "empid":"5e5deadc98f9c9472e8762df"
  }
//get number of expected event by key accmanager id for a period
  fetch('https://middle.krsherpa.com/dashboard/clientPayableAmountxxxx', {
    method: "POST",
    body: JSON.stringify(filter),
    headers: { 
      "Content-Type": "application/json",
 ...
 // To retrieve only the records where the count is greater than 10 for each status and krRelationshipMgrId combination in the "Expert" collection, you can modify the previous query as follows:
...
//To retrieve the total count for each status for each krRelationshipMgrId in the "Expert" collection, you can use the following MongoDB aggregation query:
...
//o retrieve the count of eventId for a given eventAt date range, you can use the following MongoDB aggregation query:
private eventcount4period() {

  let filter = {
    "empid":"5e5deadc98f9c9472e8762df"
  }
//get number of expected event by key accmanager id for a period
  fetch('https://middle.krsherpa.com/dashboard/eventcount4period', {
    method: "POST",
    body: JSON.stringify(filter),
    headers: { 
      "Content-Type": "application/json",
...
//o retrieve the count of eventId for a given eventAt date range, you can use the following MongoDB aggregation query:
private eventcount4periodBySpl() {

  let filter = {
    "startDate": "2020-04-03",
    "endDate": "2023-05-04",
    "subPnLId":"5acb24bceeca133f51d9a383"
}
//get number of expected event by key accmanager id for a period
...
//To obtain the count of givenToAccMgr.isnew for each givenToAccMgr.attachedBy 
private TRRCount4emp() {
...
//To obtain the count of givenToAccMgr.isnew for each givenToAccMgr.attachedBy 
private TRRCount4Team() {

  let filter = {
    "empid":"5e5deadc98f9c9472e8762df"
  }
//get number of expected event by key accmanager id for a period
  fetch('https://middle.krsherpa.com/dashboard/TRRCount4Team', {
    method: "POST",
    body: JSON.stringify(filter),
    headers: { 
      "Content-Type": "application/json",
...
//filter the projects based on a specific createdAt date range
private projectlist4period() {

  let filter = {
    "empid":"5e5deadc98f9c9472e8762df"
  }
//get number of expected event by key accmanager id for a period
  fetch('https://middle.krsherpa.com/dashboard/projectlist4period', {
    method: "POST",
    body: JSON.stringify(filter),
    headers: { 
      "Content-Type": "application/json",
...
//filter the projects based on a specific createdAt date range
private projectlist4periodbyKAC() {

  let filter = {
    "empid":"5e5deadc98f9c9472e8762df"
  }
//get number of expected event by key accmanager id for a period
  fetch('https://middle.krsherpa.com/dashboard/projectlist4periodbyKAC', {
    method: "POST",
    body: JSON.stringify(filter),
    headers: { 
      "Content-Type": "application/json",
...
//To retrieve a list of documents grouped by the "region" field
private empByRegion() {
...
private getlatest5Projects() {

  let filter = {
    "empid":"5e5deadc98f9c9472e8762df"
  }
//get number of expected event by key accmanager id for a period
  fetch('https://middle.krsherpa.com/dashboard/getlatest5Projects', {
    method: "POST",
    body: JSON.stringify(filter),
    headers: { 
      "Content-Type": "application/json",
...
// Endpoint to fetch employees by reporting manager ID
private repotingManagerId() {

  let filter = {
    "empid":"5e5deadc98f9c9472e8762df"
  }
//get number of expected event by key accmanager id for a period
  fetch('https://middle.krsherpa.com/dashboard/repotingManagerId', {
    method: "POST",
    body: JSON.stringify(filter),
    headers: { 
      "Content-Type": "application/json",
