...
import {statDatac, statData, ActiveProjects, MyTask, TeamMembers,topCollectionData} from './data';
...
import {topCollectionModel} from './CleintDB.model';

@Component({
  selector: 'app-CleintDB',
  templateUrl: './CleintDB.component.html',
  styleUrls: ['./CleintDB.component.scss']
})
...
export class CleintDBComponent implements OnInit {
