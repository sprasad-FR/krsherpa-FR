...
export class nbarComponent implements OnChanges {
...
this.drawchart();
  ...
  drawchart()
  {
    ...
    console.log ("xasis",this.data)


    this.xAxisData= this.data.x

    this.series= this.data.s

    console.log ("xasis",this.xAxisData)
