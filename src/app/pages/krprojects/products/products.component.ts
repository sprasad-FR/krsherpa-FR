...
import { NgKRProductsSortableHeader, SortEvent } from './products-sortable.directive';
...
export class ProductsComponent {
  ...
  @ViewChildren(NgKRProductsSortableHeader) headers!: QueryList<NgKRProductsSortableHeader>;
