...
@Component({
  selector: 'app-salesleadlist',
  templateUrl: './salesleadlist.component.html',
  styleUrls: ['./salesleadlist.component.scss'],
  ...
  getcomplianceDetails() {
   ...
   getLeadById(id) {
    ...
    let leadSourceArray = [
      ...
      { id: 5, lead: 'Goldmine' },
      { id: 6, lead: 'INEX ONE' },
      { id: 7, lead: 'Old Website Enquiries' },
      { id: 8, lead: 'Dormant Client' },
    ];


    const leadObj = leadSourceArray.find(item => item.id == id);
    return leadObj ? leadObj.lead : '--';
  }
...
if (id=='0')
{
  ...
  private getSalesLead(leadStatus: number = null) {
