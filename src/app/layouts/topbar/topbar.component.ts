...
export class TopbarComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) private document: any,private eventService: JSEventService, public languageService: LanguageService,
