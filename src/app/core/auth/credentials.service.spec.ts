...
describe('CredentialsService', () => {
  ...
  describe('setCredentials', () => {
    it('should authenticate user if credentials are set', () => {
      // Act
      credentialsService.setCredentials({ username: 'example@email.com', password: '123456', token: '123' });

      // Assert
      expect(credentialsService.isAuthenticated()).toBe(true);
      expect((credentialsService.credentials as User).email).toBe('me');
    });
    ...
    it('should persist credentials for the session', () => {
      // Act
      credentialsService.setCredentials({ username: 'me', password: '123456', token: '123' });
    ...
    it('should persist credentials across sessions', () => {
      // Act
      credentialsService.setCredentials({ username: 'me', password: '123456', token: '123' }, true);
